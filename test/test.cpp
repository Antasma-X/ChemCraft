...
int main() {
	...
	// std::cout<<"hi";
	// //auto waters=water.removeElement(o4);
	// std::cout<<"mannnnnnnnnnnnnnnnnnnans"<<std::endl;
	// auto waters=water.removeElement(o4);
	// std::cout<<"hidnfjdbgfejdjjjjjj"<<std::endl;
	// for(auto hg: waters){
	// 	std::cout<<"jjf: "<<hg.getMolecularFormula()<<std::endl;
	// }
	...
	Compound ozone(o1);
	ozone.addElement(o1,o2,0);
	ozone.addElement(o2,o3,0);
	ozone.createBond(o3,o1,0);

	//ozone.removeElement(o1);
	std::cout<<ozone.getMolecularMass()<<"and"<< ozone.getMolecularFormula()<<ozone.isStable()<<std::endl;

	for(auto el:o2.getValency()){
		std::cout<<el;
	}
